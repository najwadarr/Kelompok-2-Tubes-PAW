                                ...
                                <div class="row g-4">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="title" type="text"
                                            ...
                                            value="{{ old('title', $schedule->title) }}" placeholder="Imunisasi Anak">
                                        @error('title')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="event_location" type="text"
                                            ...
                                            name="event_location"
                                            value="{{ old('event_location', $schedule->event_location) }}"
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror summernote"
                                            rows="10" data-placeholder="Deskripsikan kegiatan">{!! old('description', $schedule->description) !!}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
