        ...
        <section class="section">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/elderly-check-data') }}" method="POST">
                                @csrf
                                <div class="row g-4">
                                    <div class="col-12">
                                        ...
                                        <select name="elderly_id" id="elderly_id"
                                            ...
                                            @foreach ($elderlies as $elderly)
                                                <option value="{{ $elderly->id }}" data-gender="{{ $elderly->gender }}"
                                                    ...
                                                    {{ old('elderly_id') == $elderly->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input id="body_weight" type="text"
                                            ...
                                            name="body_weight" value="{{ old('body_weight') }}" placeholder="Contoh: 55.5">
                                        @error('body_weight')
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input id="uric_acid" type="text"
                                            ...
                                            value="{{ old('uric_acid') }}" placeholder="Contoh: 7.2">
                                        @error('uric_acid')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="mobility_status" id="mobility_status"
                                            ...
                                            <option value="Mandiri"
                                                {{ old('mobility_status') == 'Mandiri' ? 'selected' : '' }}>Mandiri
                                            </option>
                                            <option value="Bantuan Alat"
                                                {{ old('mobility_status') == 'Bantuan Alat' ? 'selected' : '' }}>Bantuan
                                                Alat</option>
                                            <option value="Dibantu Orang Lain"
                                                {{ old('mobility_status') == 'Dibantu Orang Lain' ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="cognitive_status" id="cognitive_status"
                                            ...
                                            <option value="Normal"
                                                {{ old('cognitive_status') == 'Normal' ? 'selected' : '' }}>Normal</option>
                                            <option value="Penurunan Ringan"
                                                {{ old('cognitive_status') == 'Penurunan Ringan' ? 'selected' : '' }}>
                                                Penurunan Ringan</option>
                                            <option value="Demensia"
                                                {{ old('cognitive_status') == 'Demensia' ? 'selected' : '' }}>Demensia
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="nutritional_status" id="nutritional_status"
                                            ...
                                            <option value="Baik"
                                                {{ old('nutritional_status') == 'Baik' ? 'selected' : '' }}>Baik</option>
                                            <option value="Kurang"
                                                {{ old('nutritional_status') == 'Kurang' ? 'selected' : '' }}>Kurang
                                            </option>
                                            <option value="Lebih"
                                                {{ old('nutritional_status') == 'Lebih' ? 'selected' : '' }}>Lebih</option>
                                        </select>
