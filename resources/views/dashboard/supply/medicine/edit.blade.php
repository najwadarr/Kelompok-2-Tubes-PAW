        ...
        <section class="section">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url("/medicine-data/{$medicine->id}") }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row g-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="stock" type="number"
                                            ...
                                            value="{{ old('stock', $medicine->stock) }}" placeholder="0">
                                        @error('stock')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="entry_date" type="date"
                                            ...
                                            value="{{ old('entry_date', $medicine->entry_date) }}">
                                        @error('entry_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="expiry_date" type="date"
                                            ...
                                            name="expiry_date" value="{{ old('expiry_date', $medicine->expiry_date) }}">
                                        @error('expiry_date')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="notes" id="notes" class="form-control @error('notes') is-invalid @enderror" rows="5"
                                            maxlength="100" placeholder="Untuk anak 9-12 bulan">{{ old('notes', $medicine->notes) }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
