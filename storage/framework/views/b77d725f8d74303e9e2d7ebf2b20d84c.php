                        ...
                        <div class="card-body">
                            ...
                            <?php if(Auth::user()->role !== 'peminjam'): ?>
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <a href="<?php echo e(route('returns.create')); ?>" class="btn btn-primary ml-auto">Pengembalian</a>
                                </div>
                            <?php endif; ?> 
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/user/Documents/Laravel-9.1/posyandu/resources/views/return/index.blade.php ENDPATH**/ ?>