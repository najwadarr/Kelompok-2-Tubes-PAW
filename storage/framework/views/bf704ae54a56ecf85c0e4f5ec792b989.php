            ...
            <div class="modal-content">
                <div class="modal-body p-3">
                    ...
                    <div class="row justify-content-center align-items-center g-4">
                        <?php if(Auth::user()?->role !== 'family_parent'): ?>
                            <div class="col-md-6">
                                <div class="p-2 rounded border border-secondary">
                                    ...
                                    <div class="p-2 my-2 text-center">
                                        <div class="qr-wrapper" data-qr-id="officer_qr">
                                            <div class="qr-code" data-url="<?php echo e($site->officer_wa_group_url); ?>"></div>
                                            <i class="fab fa-whatsapp qr-icon"></i>
                                        </div>
                                    </div>

                                    <div class="text-center qr-link">
                                        <a href="<?php echo e($site->officer_wa_group_url); ?>"
                                            target="_blank"><?php echo e($site->officer_wa_group_url); ?></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-2 rounded border border-secondary">
                                ...
                                <div class="p-2 my-2 text-center">
                                    <div class="qr-wrapper" data-qr-id="user_qr">
                                        <div class="qr-code" data-url="<?php echo e($site->wa_group_url); ?>"></div>
                                        <i class="fab fa-whatsapp qr-icon"></i>
                                    </div>
                                </div>

                                <div class="text-center qr-link">
                                    <a href="<?php echo e($site->wa_group_url); ?>" target="_blank"><?php echo e($site->wa_group_url); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.schedule-filter').forEach(item => {
                item.addEventListener('click', function(e) {
                    ...
                    const url = `<?php echo e(url('/schedule/ajax')); ?>/${day}`;
        ...
        <script>
            $(document).ready(function() {
                ...
                initChart({
                    ...
                    endpointUrl: "<?php echo e(url('/pregnancy-check-data/ajax')); ?>",
            ...
            $(document).ready(function() {
                ...
                $('.nutrition-chart-canvas').each(function() {
                    ...
                    initNutritionStatusChart({
                        selectId: selectId,
                        canvasId: canvasId,
                        endpointUrl: "<?php echo e(url('/children-nutrition-status/ajax')); ?>",
        ...
        <script>
            $(document).ready(function() {
                ...
                initBarChartMultipleDatasets({
                    ...
                    endpointUrl: "<?php echo e(url('/nutrition-status/ajax')); ?>"
                });
                ...
                initChart({
                    ...
                    endpointUrl: "<?php echo e(url('/immunization-data/ajax')); ?>",
                ...
                initChart({
                    ...
                    endpointUrl: "<?php echo e(url('/weighing-data/ajax')); ?>",
                ...
                initChart({
                    ...
                    endpointUrl: "<?php echo e(url('/elderly-check-data/ajax')); ?>",
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Kulyeah\SEMESTER 4\PWEB\Tubes\laravel_paw\resources\views/index-dashboard.blade.php ENDPATH**/ ?>