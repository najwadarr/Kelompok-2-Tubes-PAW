    ...
    <ul class="navbar-nav navbar-right">
            ...
            <li class="dropdown dropdown-list-toggle">
                ...
                <div class="dropdown-menu dropdown-list dropdown-menu-right">
                    ...
                    <div class="dropdown-footer text-center">
                        <a href="<?php echo e(url('/parent-data?status=not-active')); ?>">Selengkapnya <i
        ...
        <li class="dropdown">
            ...
            <a href="#" data-toggle="dropdown"
                ...
                <div class="d-sm-none d-lg-inline-block"><?php echo e($fullname); ?></div>
                <img alt="image" src="<?php echo e(asset('img/avatar/avatar-1.png')); ?>" class="rounded-circle ml-1">
            </a>
            <div class="dropdown-menu dropdown-menu-right mr-2">
                <a href="<?php echo e($profile_url); ?>" class="dropdown-item has-icon">
...
<?php /**PATH C:\Kulyeah\SEMESTER 4\PWEB\Tubes\laravel_paw\resources\views/components/dashboard-navbar.blade.php ENDPATH**/ ?>