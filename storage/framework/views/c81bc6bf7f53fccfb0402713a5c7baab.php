                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ctr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo e($ctr->nama_kategori); ?></td>
                                                <td class="text-right"><?php echo e($ctr->deskripsi); ?></td>
                                                <td>
                                                    <div class="d-flex justify-content-center" style="gap: .5rem">
                                                        
                                                        <?php if(Auth::user()->role ==  'admin'): ?>
                                                            <a href="<?php echo e(url("/categories/{$ctr->id}/edit")); ?>"
                                                                class="btn btn-primary" data-toggle="tooltip"
                                                                title="Ubah">
                                                                <i class="fas fa-pencil"></i>
                                                            </a>
                                                            <form action="<?php echo e(url("/categories/{$ctr->id}")); ?>"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Kulyeah\SEMESTER 4\PWEB\Tubes\laravel_paw\resources\views/categories/index.blade.php ENDPATH**/ ?>