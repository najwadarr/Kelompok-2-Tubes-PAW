                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center" style="gap: .5rem">
                                                            ...
                                                            <?php if(Auth::user()->role !== 'peminjam'): ?>
                                                                <a href="<?php echo e(route('loans.edit', $loan->id)); ?>" class="btn btn-primary" title="Ubah">
                                                                    <i class="fas fa-pencil-alt"></i>
                                                                </a>
                                                            <?php if($loan->status !== 'returned'): ?>
                                                                <a href="<?php echo e(route('return.create', $loan->id)); ?>" class="btn btn-success" title="Pengembalian">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/user/Documents/Laravel-9.1/posyandu/resources/views/loans/index.blade.php ENDPATH**/ ?>