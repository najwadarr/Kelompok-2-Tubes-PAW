            ...
            <div class="modal-body p-3">
                ...
                <div class="mb-4">
                    <p class="text-lead">Jika Anda membutuhkan bantuan atau memiliki pertanyaan, silakan hubungi admin
                        melalui WhatsApp: <span class="text-success"><?php echo e($site->phone_number); ?></span> atau klik
                    ...
                    <div class="rounded p-2" style="background-color: rgba(103,119,239,0.1)">
                        <p class="text-lead text-center mb-0">
                            ...
                            Senin hingga Sabtu, pukul 08.00 - 14.00 <?php echo e($zone); ?>.
                        </p>
                    </div>
                </div>

                <a href="https://wa.me/<?php echo e($site->phone_number); ?>?text=Hai Admin Peminjaman <?php echo e($site->village_name); ?>."
                    target="_blank" class="btn btn-success w-100"><i class="fab fa-whatsapp mr-1"></i> Hubungi Admin</a>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\Kulyeah\SEMESTER 4\PWEB\Tubes\laravel_paw\resources\views/components/help-center-modal.blade.php ENDPATH**/ ?>